...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/XLHSDangKy/ToChuc_NguoiDaiDien.cshtml")]
    public partial class _Views_XLHSDangKy_ToChuc_NguoiDaiDien_cshtml : System.Web.Mvc.WebViewPage<MPLIS.Libraries.Data.XuLyHoSo.Models.ToChucLS>
    {
        public _Views_XLHSDangKy_ToChuc_NguoiDaiDien_cshtml()
        {
        }
...
WriteLiteral(">\r\n");
            ...
            #line 8 "..\..\Views\XLHSDangKy\ToChuc_NguoiDaiDien.cshtml"
...
WriteLiteral("></i> Thêm mới</button>\r\n");
            ...
            #line 11 "..\..\Views\XLHSDangKy\ToChuc_NguoiDaiDien.cshtml"
                    }
                    else
                    {
...
WriteLiteral("></i> Lưu thông tin</button>\r\n");
            ...
            #line 15 "..\..\Views\XLHSDangKy\ToChuc_NguoiDaiDien.cshtml"
                    }
...
WriteLiteral("        ");
            ...
            #line 30 "..\..\Views\XLHSDangKy\ToChuc_NguoiDaiDien.cshtml"
...
"             $.ajax({\r\n                    type: \"POST\",\r\n                    ur" +
"l: \'/XLHSDangKy/Save_FormToChuc_ChiTietNguoiDaiDienID\',\r\n                    dat" +
"a: { data: JSON.stringify(objNguoiDaiDien) },\r\n                    dataType: \"ht" +
"ml\",\r\n                    success: function (html) {\r\n                        if" +
" ($(\'#formTTToChucID [name=NGUOIDAIDIENID]\').val() == \"\") {\r\n                   " +
"         alert(\'Thêm mới thông tin Người Đại Diện thành công!\');\r\n              " +
"          } else {\r\n                            alert(\'Cập nhật thông tin Người " +
"Đại Diện thành công!\');\r\n                        }\r\n                        $(\'#" +
...
"\r\n                    }\r\n                })\r\n            })\r\n\r\n            $(\'#B" +
"tnClear_FormToChuc_ChiTietNguoiDaiDienID\').on(\'click\', function () {\r\n          " +
"      $(\'#FormToChuc_ChiTietNguoiDaiDienID\').append(divProcessBar);\r\n           " +
"     $.ajax({\r\n                    type: \"POST\",\r\n                    url: \'/XLH" +
"SDangKy/XoaTrang_FormToChuc_ChiTietNguoiDaiDienID\',\r\n                    dataTyp" +
"e: \"html\",\r\n                    success: function (html) {\r\n                    " +
"    $(\'#divTCCTNguoiDaiDienID\').html(html);\r\n                    },\r\n           " +
"         error: function (jqXHR, textStatus, errorThrown) {\r\n                   " +
"     alert(\'Lỗi: \' + errorThrown);\r\n                    },\r\n                    " +
"complete: function () {\r\n                        $(\'.overlay\', $(\'#FormToChuc_Ch" +
"iTietNguoiDaiDienID\')).remove();\r\n                    }\r\n                })\r\n   " +
"         })\r\n\r\n        })\r\n\r\n    </script>\r\n</div>\r\n");
