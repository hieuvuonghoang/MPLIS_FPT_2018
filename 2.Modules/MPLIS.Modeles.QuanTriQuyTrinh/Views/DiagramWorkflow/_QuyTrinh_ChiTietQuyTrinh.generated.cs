...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/DiagramWorkflow/_QuyTrinh_ChiTietQuyTrinh.cshtml")]
    public partial class _Views_DiagramWorkflow__QuyTrinh_ChiTietQuyTrinh_cshtml : System.Web.Mvc.WebViewPage<AppCore.Models.QT_QUYTRINH>
    {
        public _Views_DiagramWorkflow__QuyTrinh_ChiTietQuyTrinh_cshtml()
        {
        }
...
WriteLiteral(">Thông tin chi tiết quy trình</h3>\r\n    </div>\r\n    <div");

WriteLiteral(" class=\"p-0 box-body\"");
...
WriteLiteral("        ");
            ...
            #line 8 "..\..\Views\DiagramWorkflow\_QuyTrinh_ChiTietQuyTrinh.cshtml"
...
WriteLiteral(@">
    $(document).ready(function () {
        ...
        $('#quyTrinh-li2').on('click', function () {
            $('#quyTrinh-tabID').css({ ""height"": ""550px"" });
            $.ajax({
                type: ""POST"",
                url: ""/DiagramWorkflow/_QuyTrinh_SoDoQuyTrinh"",
                dataType: ""html"",
                success: function (html) {
                    $('#quyTrinh-tabID').html(html);
                }
        ...
        $('#quyTrinh-li3').on('click', function () {
            ...
            $.ajax({
                type: ""POST"",
                url: ""/DiagramWorkflow/_QuyTrinh_CauHinhXuLy"",
                dataType: ""html"",
                success: function (html) {
                    $('#quyTrinh-tabID').html(html);
                }
